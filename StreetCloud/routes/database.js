...
var host = "64.251.240.181";    //from GCloud instance (change to match your db)
var database = "streetclouddb";  //database name
var user = "root";         //username (change to match your db)
var password = "streetcloud341";  //password (change to match your db, yes this is very poor practice)
